...
describe("Helpers", () => {
  ...
  it("check padRight string ok", (done) => {
    expect(padRight("Teste", 10, 10, " ", false)).to.be.deep.equal(
      "Teste     "
    );
    done();
  });
        ...
        resolutions: [
          {
            ...
            unit: "001",
            unitName: "N-m",
            timeValue: 12345, // Now a number instead of a string
          },
          {
            firstIndex: 105,
            lastIndex: 6023,
            ...
            dataType: 1,
            unit: "099",
            unitName: "", // Adjusted to be an empty string
            timeValue: 88, // Now a number instead of a string
          },
        ],
      },
    };

    let value = processResolutionFields(
      obj,
      buffer,
      "resolutions",
      2,
